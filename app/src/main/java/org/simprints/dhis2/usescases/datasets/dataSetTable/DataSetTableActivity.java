...
import org.simprints.dhis2.databinding.ActivityDatasetTableBinding;
...
public class DataSetTableActivity extends ActivityGlobalAbstract implements DataSetTableContract.View {
    ...
    public void isDataSetOpen(boolean dataSetIsOpen) {
        ...
        binding.programLockText.setText(!dataSetIsOpen ? getString(org.simprints.dhis2.R.string.event_open) : getString(org.simprints.dhis2.R.string.completed));
