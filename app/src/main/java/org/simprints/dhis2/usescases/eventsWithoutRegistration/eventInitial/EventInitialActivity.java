...
import org.simprints.dhis2.data.forms.FormSectionViewModel;
...
import org.simprints.dhis2.databinding.ActivityEventInitialBinding;
import org.simprints.dhis2.databinding.CategorySelectorBinding;
import org.simprints.dhis2.databinding.WidgetDatepickerBinding;
import org.simprints.dhis2.usescases.eventsWithoutRegistration.eventCapture.EventCaptureActivity;
import org.simprints.dhis2.usescases.general.ActivityGlobalAbstract;
import org.simprints.dhis2.usescases.map.MapSelectorActivity;
import org.simprints.dhis2.usescases.qrCodes.eventsworegistration.QrEventsWORegistrationActivity;
import org.simprints.dhis2.utils.ColorUtils;
import org.simprints.dhis2.utils.Constants;
import org.simprints.dhis2.utils.DateUtils;
import org.simprints.dhis2.utils.DialogClickListener;
import org.simprints.dhis2.utils.EventCreationType;
import org.simprints.dhis2.utils.EventMode;
import org.simprints.dhis2.utils.HelpManager;
import org.simprints.dhis2.utils.analytics.AnalyticsConstants;
import org.simprints.dhis2.utils.customviews.CategoryOptionPopUp;
import org.simprints.dhis2.utils.customviews.CoordinatesView;
import org.simprints.dhis2.utils.customviews.CustomDialog;
import org.simprints.dhis2.utils.customviews.OrgUnitDialog;
import org.simprints.dhis2.utils.customviews.PeriodDialog;
...
import static org.simprints.dhis2.utils.Constants.ENROLLMENT_UID;
import static org.simprints.dhis2.utils.Constants.EVENT_CREATION_TYPE;
import static org.simprints.dhis2.utils.Constants.EVENT_PERIOD_TYPE;
import static org.simprints.dhis2.utils.Constants.ONE_TIME;
import static org.simprints.dhis2.utils.Constants.ORG_UNIT;
import static org.simprints.dhis2.utils.Constants.PERMANENT;
import static org.simprints.dhis2.utils.Constants.PROGRAM_UID;
import static org.simprints.dhis2.utils.Constants.TRACKED_ENTITY_INSTANCE;
import static org.simprints.dhis2.utils.analytics.AnalyticsConstants.CLICK;
import static org.simprints.dhis2.utils.analytics.AnalyticsConstants.CREATE_EVENT;
import static org.simprints.dhis2.utils.analytics.AnalyticsConstants.DELETE_EVENT;
import static org.simprints.dhis2.utils.analytics.AnalyticsConstants.SHOW_HELP;
