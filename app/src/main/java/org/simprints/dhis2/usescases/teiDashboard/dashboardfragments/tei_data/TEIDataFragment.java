package org.simprints.dhis2.usescases.teiDashboard.dashboardfragments.tei_data;
...
import org.simprints.dhis2.databinding.FragmentTeiDataBinding;
import org.simprints.dhis2.usescases.eventsWithoutRegistration.eventInitial.EventInitialActivity;
import org.simprints.dhis2.usescases.general.FragmentGlobalAbstract;
import org.simprints.dhis2.usescases.orgunitselector.OUTreeActivity;
import org.simprints.dhis2.usescases.programStageSelection.ProgramStageSelectionActivity;
import org.simprints.dhis2.usescases.teiDashboard.DashboardProgramModel;
import org.simprints.dhis2.usescases.teiDashboard.DashboardViewModel;
import org.simprints.dhis2.usescases.teiDashboard.TeiDashboardMobileActivity;
import org.simprints.dhis2.usescases.teiDashboard.dashboardfragments.tei_data.tei_events.EventAdapter;
import org.simprints.dhis2.usescases.teiDashboard.dashboardfragments.tei_data.tei_events.EventViewModel;
import org.simprints.dhis2.usescases.teiDashboard.dashboardfragments.tei_data.tei_events.EventViewModelType;
...
import org.simprints.dhis2.utils.ObjectStyleUtils;
import org.simprints.dhis2.utils.OrientationUtilsKt;
import org.simprints.dhis2.utils.customviews.CategoryComboDialog;
import org.simprints.dhis2.utils.customviews.CustomDialog;
import org.simprints.dhis2.utils.filters.FilterManager;
import org.simprints.dhis2.utils.filters.FiltersAdapter;
...
import static org.simprints.dhis2.utils.Constants.EVENT_REPEATABLE;
import static org.simprints.dhis2.utils.Constants.EVENT_SCHEDULE_INTERVAL;
...
import static org.simprints.dhis2.utils.analytics.AnalyticsConstants.CREATE_EVENT_TEI;
import static org.simprints.dhis2.utils.analytics.AnalyticsConstants.TYPE_EVENT_TEI;
