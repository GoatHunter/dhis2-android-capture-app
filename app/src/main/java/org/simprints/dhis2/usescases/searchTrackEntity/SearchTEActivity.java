...
import org.simprints.dhis2.data.forms.dataentry.ProgramAdapter;
import org.simprints.dhis2.data.forms.dataentry.fields.RowAction;
import org.simprints.dhis2.data.tuples.Trio;
import org.simprints.dhis2.databinding.ActivitySearchBinding;
import org.simprints.dhis2.usescases.enrollment.EnrollmentActivity;
...
import org.simprints.dhis2.usescases.searchTrackEntity.adapters.FormAdapter;
import org.simprints.dhis2.usescases.searchTrackEntity.adapters.RelationshipLiveAdapter;
import org.simprints.dhis2.usescases.searchTrackEntity.adapters.SearchTeiLiveAdapter;
import org.simprints.dhis2.usescases.searchTrackEntity.adapters.SearchTeiModel;
...
import org.simprints.dhis2.utils.FileResourcesUtil;
import org.simprints.dhis2.utils.HelpManager;
import org.simprints.dhis2.utils.customviews.CoordinatesView;
import org.simprints.dhis2.utils.customviews.ScanTextView;
import org.simprints.dhis2.utils.filters.FilterManager;
import org.simprints.dhis2.utils.filters.FiltersAdapter;
import org.simprints.dhis2.utils.maps.MapLayerDialog;
import org.simprints.dhis2.utils.maps.MapLayerManager;
import org.simprints.dhis2.utils.maps.MapboxExtensionKt;
import org.simprints.dhis2.utils.maps.MarkerUtils;
...
import static org.simprints.dhis2.usescases.eventsWithoutRegistration.eventInitial.EventInitialPresenter.ACCESS_LOCATION_PERMISSION_REQUEST;
import static org.simprints.dhis2.utils.analytics.AnalyticsConstants.CHANGE_PROGRAM;
