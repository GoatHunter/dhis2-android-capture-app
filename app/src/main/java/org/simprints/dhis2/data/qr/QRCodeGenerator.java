package org.simprints.dhis2.data.qr;
...
import org.simprints.dhis2.usescases.qrCodes.QrViewModel;
...
import static org.simprints.dhis2.data.qr.QRjson.ATTR_JSON;
import static org.simprints.dhis2.data.qr.QRjson.DATA_JSON;
import static org.simprints.dhis2.data.qr.QRjson.DATA_JSON_WO_REGISTRATION;
import static org.simprints.dhis2.data.qr.QRjson.ENROLLMENT_JSON;
import static org.simprints.dhis2.data.qr.QRjson.EVENTS_JSON;
import static org.simprints.dhis2.data.qr.QRjson.EVENT_JSON;
import static org.simprints.dhis2.data.qr.QRjson.TEI_JSON;
...
/*        data.add(enrollment.coordinate() != null ? String.valueOf(enrollment.coordinate().latitude()) : "");
    ...
    private TrackedEntityInstance saveTeiData(String teiData) {
        ...
        //TODO: develop SDK has moved .insert outside .database
        d2.databaseAdapter()
                .insert("TrackedEntityInstance", null, tei.toContentValues());
    ...
    private Enrollment saveEnrollmentData(TrackedEntityInstance tei, String enrollmentData) {
        ...
        d2.databaseAdapter().insert("Enrollment", null, enrollment.toContentValues());
        return enrollment;
    }
    ...
    public void saveAttribute(TrackedEntityInstance tei, String attrData) {
        ...
        TrackedEntityAttributeValue attribute = TrackedEntityAttributeValue.builder()
                ...
                .value(data[1])
                .build();
        d2.databaseAdapter().insert("TrackedEntityAttributeValue", null, attribute.toContentValues());
    }
    ...
    public Event saveEvent(Enrollment enrollment, String eventData) {
        ...
        d2.databaseAdapter().insert("Event", null, event.toContentValues());
    ...
    public void saveDataElement(Event event, String deData) {
        ...
        TrackedEntityDataValue dataValue = TrackedEntityDataValue.builder()
                ...
                .event(event.uid())
                .build();
        d2.databaseAdapter().insert("TrackedEntityDataValue", null, dataValue.toContentValues());
    }
